...
public class Parsers {
    ...
    public static Pair<CommunicationCode, ArrayList<String>> parseMessageFromServer (String message) {
    ...
    public static String parseMessageToServer (CommunicationCode code, ArrayList<String> data){
        StringBuilder response = new StringBuilder().append(code.getCodeId() + ";");
        if (data != null)
